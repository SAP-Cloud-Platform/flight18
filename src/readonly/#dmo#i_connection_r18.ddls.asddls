@AbapCatalog.sqlViewName: '/DMO/ICONNE_R18'
...
define view /DMO/I_Connection_R18
  as select from /dmo/connecti_18 as Connection

  association [1..*] to /DMO/I_Flight_R18 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier18  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport18',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
