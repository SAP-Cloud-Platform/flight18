@AbapCatalog.sqlViewName: '/DMO/CURRHLP18'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Help View for Currency Conversion'
define view /DMO/CURRENCY_HELPER18
  with parameters
    amount             : /dmo/total_price18,
    source_currency    : /dmo/currency_code18,
    target_currency    : /dmo/currency_code18,
    exchange_rate_date : /dmo/booking_date18

  as select from /dmo/agency18
