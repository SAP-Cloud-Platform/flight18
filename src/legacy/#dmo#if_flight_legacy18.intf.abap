...
INTERFACE /dmo/if_flight_legacy18
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL18
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel18     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING18
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking18    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_18
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_18 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT18
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id18.
  ...
  TYPES booking_id TYPE /dmo/booking_id18.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id18.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL18, /DMO/BOOKING18, /DMO/BOOK_SUP_18 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code18.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code18,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status18,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel18_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id18.
  INCLUDE TYPE /dmo/booking18_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id18.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id18.
  INCLUDE TYPE /dmo/book_sup_18_data.
