@AbapCatalog.sqlViewName: '/DMO/IBOOKSU_U18'
...
define view /DMO/I_BookingSupplement_U18
  as select from /dmo/book_sup_18 as BookingSupplement

  association        to parent /DMO/I_Booking_U18  as _Booking         on  $projection.TravelID  = _Booking.TravelID
                                                                     and $projection.BookingID = _Booking.BookingID

  association [1..1] to /DMO/I_Supplement18     as _Product  on $projection.SupplementID = _Product.SupplementID
  association [1..*] to /DMO/I_Supplement18Text18 as _SupplementText on  $projection.SupplementID = _SupplementText.SupplementID
{
  ...
  key BookingSupplement.booking_supplement_id  as BookingSupplementID,
      ...
      @Consumption.valueHelpDefinition: [{entity: {name: '/DMO/I_SUPPLEMENT18', element: 'SupplementID' },
